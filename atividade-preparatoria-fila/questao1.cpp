...
void imprimir_dado(const Dado& umDado)
{
    cout<<"Nome: " << umDado.nome <<" Assunto: " << umDado.assunto<< " Tipo: "<< umDado.tipo<< 
...
{
    if (this->Vazia()) throw runtime_error("Erro: fila vazia!");
    cout<<"Nome: " << mFila[posPrimeiro].nome <<" Assunto: " << mFila[posPrimeiro].assunto<< " Tipo: "<< mFila[posPrimeiro].tipo<< 
    " Processo: "<< mFila[posPrimeiro].nProcesso <<endl;    
